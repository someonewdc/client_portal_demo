...
Пользователь написал «выполни ux задачу 5». Этот файл — полный вход. Другой
...
2. Playwright **до** Vue (все четыре статуса D-037):
   - З-10043: виден exact
   ...
   - З-10042 `/r/seed-z10042-calc-portline`:
...
- Given каждый из четырёх кабинетов выше, Then видна ровно своя фиксированная фраза.
...
Skill `pr-review`. Дальше: «выполни ux задачу 6» → `docs/ux/task-06.md`.
