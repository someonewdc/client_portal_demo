...
| UX/UI понятности: задача N    | [`ux/README.md`](ux/README.md) (`выполни задачу N` → `ux/task-NN.md`)           |

Предметный код (фичи 1–27) пишут отдельные чаты по `docs/llm/feature-NN.md`.
Доработки UX/UI понятности — по `docs/ux/task-NN.md`, не в общем скоупе фич.
