...
| Копируемый промпт фичи N      | [`llm/feature-01.md`](llm/feature-01.md) … [`feature-08.md`](llm/feature-08.md) |
...
генерирует api-client и сверяет diff до gates, затем compose-smoke и e2e (D-018).
