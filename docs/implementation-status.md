...
Заготовка workspace создана. Продуктовые документы, промпты фич 1–6 и правки контракта
по ревью (D-014…D-016, каталог сидов) лежат в `docs/`. Предметный MVP (Prisma-домен,
Nuxt-экраны) не начат.
...
| Правки контракта по ревью        | выполнен (этот PR)                |
