...
- `letterReading` — только в HTTP кабинета: строка вывода по письму у З-10046 (D-057);
  у каталожных пяти поля нет (omit, как `demoLive`). Не колонка Prisma в v1; значение из
  `live-request-fixture`. Канон:
